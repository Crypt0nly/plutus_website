...
const connectors = [
  {
    name: 'Discord',
    description: 'Send messages, manage servers, and let Plutus respond to your community.',
    color: '#5865F2',
    icon: (
  ...
  {
    name: 'Telegram',
    description: 'Chat with Plutus directly from Telegram. Send tasks, get updates, stay in control.',
    color: '#26A5E4',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="26" height="26">
  ...
  {
    name: 'WhatsApp',
    description: 'Receive and send WhatsApp messages through Plutus for seamless communication.',
    color: '#25D366',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="26" height="26">
  ...
  {
    name: 'Gmail',
    description: 'Read, send, and manage your emails. Let Plutus handle your inbox automatically.',
    color: '#EA4335',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="26" height="26">
  ...
  },
  {
    ...
    description: 'Create events, check your schedule, and let Plutus manage your time.',
    color: '#4285F4',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="26" height="26">
  ...
  {
    name: 'Google Drive',
    description: 'Upload, download, and organize files in your Drive without lifting a finger.',
    color: '#34A853',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="26" height="26">
  ...
  {
    name: 'GitHub',
    description: 'Create issues, manage PRs, push code, and automate your entire dev workflow.',
    color: '#f0f0f0',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="26" height="26">
  ...
  {
    name: 'Vercel',
    description: 'Deploy your web projects instantly. Plutus can push and publish with one command.',
    color: '#f0f0f0',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="26" height="26">
  ...
  {
    name: 'Netlify',
    description: 'Continuous deployment and hosting — Plutus can ship your sites automatically.',
    color: '#00C7B7',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="26" height="26">
  ...
  {
    name: 'Custom API',
    description: 'Connect any REST API. Define endpoints once and Plutus can call them on demand.',
    color: '#f59e0b',
    icon: (
  ...
  {
    name: 'OpenAI',
    description: 'Power Plutus with GPT-4o, o1, and the latest OpenAI models.',
    color: '#10a37f',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="26" height="26">
  ...
  {
    name: 'Anthropic',
    description: 'Use Claude 3.5 Sonnet and Opus for nuanced reasoning and long-context tasks.',
    color: '#d97706',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="26" height="26">
...
// ── "Connect anything" card ───────────────────────────────────────────────────
const PlusCard = () => (
  <motion.div
    initial={{ opacity: 0, scale: 0.9 }}
    whileInView={{ opacity: 1, scale: 1 }}
    viewport={{ once: true, margin: '-30px' }}
    transition={{ duration: 0.4, delay: connectors.length * 0.04 }}
    style={{
      padding: '28px 24px',
  ...
  >
    ...
    <div>
      <p style={{ fontSize: 14, fontWeight: 700, color: '#c4b5fd', marginBottom: 4 }}>
        Connect Anything
      </p>
      <p style={{ fontSize: 12, color: '#6b6b80', lineHeight: 1.5 }}>
        Any REST API, webhook, or service — if it has an API, Plutus can use it.
      </p>
    </div>
  </motion.div>
)
...
export default function Connectors() {
  return (
    <section id="connectors" style={{ padding: '100px 0' }}>
      <div className="section-container">
        ...
        >
          ...
          <p style={{
            ...
            Plutus connects to the apps and services you already use. Set it up once — then
            just tell Plutus what to do and it handles the rest.
          </p>
        </motion.div>
        ...
        >
          <div>
            ...
            <p style={{ fontSize: 14, color: '#7a7a8a', maxWidth: 480, lineHeight: 1.6 }}>
              If it has an API, Plutus can connect to it. Use the Custom API connector to
              define any endpoint — then just describe what you want in plain English.
            </p>
          </div>
